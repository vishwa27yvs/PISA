...
# Data
parser.add_argument('--dataset', type=str, default='cifar10', choices=['cifar10', 'cifar100', 'tiny-imagenet-200','stl10'], help='Choose between Cifar10/100 and Tiny-ImageNet.')
